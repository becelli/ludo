...
public class MainWindow extends javax.swing.JFrame {
        ...
        layout.setVerticalGroup(
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addComponent(diceLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 112,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(10, 10, 10)
                                                .addComponent(rollButton)
    ...
    private void rollButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_rollButtonActionPerformed
        ...
        this.suaCorInfoLabel.setText("<html><font color='#" + this.colorMap.get(this.myColor) + "'>"
                + this.translate.get(this.myColor) + "</font></html>");
    ...
    private void forfeitMenuItemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_forfeitMenuItemActionPerformed
        ...
        boolean res = JOptionPane.showConfirmDialog(this, "Quer mesmo desistir?", "Desistência",
    ...
    private void regrasMenuItemActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_regrasMenuItemActionPerformed
        ...
        sb.append(
                "<li> Para que o jogo comece, deve haver um host e um cliente. A conexão deve ser feita no menu superior Conexão.");
        ...
        sb.append(
                "<li> Caso um peão, ao mover-se, encontre um ou mais peões adversários, os adversários voltarão a sua base.<br>Isto não acontece em casas especiais.");
        sb.append(
                "<li> Após jogar o dado, o jogador deve clicar no peão para movê-lo. O peão só se move caso já esteja fora da base.");
